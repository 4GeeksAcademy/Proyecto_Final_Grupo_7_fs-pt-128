					...
					<div className="d-flex ms-auto">
						{isLogin ? (
							<div className="dropdown">
								<button
									className="btn auth px-4 py-2 fw-bold rounded-pill dropdown-toggle d-flex align-items-center gap-2"
									type="button"
							...
							<div className="d-flex gap-2">
								<Link to="/signup">
									<button className="btn auth px-5 py-2 fw-bold rounded-pill">Registrate</button>
								</Link>
								<Link to="/login">
									<button className="btn auth px-5 py-2 fw-bold rounded-pill">Ingresar</button>
								</Link>
							</div>
						)}
					</div>
